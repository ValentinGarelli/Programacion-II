...
void PedirDatos(char nom[15],int &edad,char &sexo,float &peso,float &altura){
    string auxS;

    cout << "Ingrese el nombre, la edad, el sexo (H para hombre y M para mujer), el peso y la altura de una persona en ese orden porfavor: ";
    cin >> nom;
    cin >> edad;
    cin >> auxS;
    sexo = auxS[0];
